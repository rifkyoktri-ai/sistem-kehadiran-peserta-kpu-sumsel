...
export default function QRScanner({ onScan }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-card p-8 mx-auto max-w-lg mt-4 border border-[#E2E8F0]">
      ...
      <div className="relative mx-auto max-w-[320px] bg-black rounded-lg overflow-hidden flex items-center justify-center min-h-[250px]" style={{ border: '2px solid #003580' }}>
        ...
        <div id="qr-reader-container" ref={readerRef} className="w-full" />
      </div>

      <p className="text-sm text-[#5A6A8A] text-center mt-4 font-body">Arahkan QR Code ID Card peserta ke kamera</p>
